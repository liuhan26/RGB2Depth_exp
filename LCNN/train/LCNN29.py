...
def LCNN29(images, labels):
    ...
    with tf.name_scope('loss'):
        loss = tf.reduce_mean(tf.nn.sparse_softmax_cross_entropy_with_logits(labels=labels, logits=class_layer))
...
#             str1 = ' Epoc: ' + str(j + epoc) + '\t|Iter: ' + str(i + iters) + '\t|Train_Loss: ' + str(
#                 ls) + '\t|Train_Acc: ' + str(ac)
#             print(str1)
#             f_log.write(str1 + '\n')
#
...
#                 str1 = ' Epoc: ' + str(j + epoc) + '\t|Iter: ' + str(i + iters) + '\t|Val_Loss: ' + str(
#                     ls_val) + '\t|Val_Acc: ' + str(acc_val)
#                 print(str1)
#                 f_log.write(str1 + '\n')
#
